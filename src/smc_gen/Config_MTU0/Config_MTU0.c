...
void R_Config_MTU0_Create(void)
{
    ...
    MTU0.TIORL.BYTE = _00_MTU_IOC_DISABLE | _70_MTU_IOD_HT;
    MTU0.TMDR1.BYTE = _00_MTU_NORMAL;
    MTU0.TGRA = _1F3F_TGRA0_VALUE;
    MTU0.TGRB = _1F3F_TGRB0_VALUE;
    MTU0.TGRC = _1F3F_TGRC0_VALUE;
    MTU0.TGRD = _1F3F_TGRD0_VALUE;
    MTU0.TGRE = _1F3F_TGRE0_VALUE;
    MTU0.TGRF = _1F3F_TGRF0_VALUE;
