...
#if FAST_INTERRUPT_VECTOR == VECT_S12AD1_S12ADI1
#pragma interrupt r_Config_S12AD1_interrupt(vect=VECT(S12AD1,S12ADI1),fint)
#else
#pragma interrupt r_Config_S12AD1_interrupt(vect=VECT(S12AD1,S12ADI1))
#endif
