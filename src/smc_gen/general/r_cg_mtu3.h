...
#define _00_MTU_TVCOR_SKIP_COUNT_0      (0x00U) /* Does not skip TCIV4 or TCIV7 interrupts */
#define _01_MTU_TVCOR_SKIP_COUNT_1      (0x01U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 1 */
#define _02_MTU_TVCOR_SKIP_COUNT_2      (0x02U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 2 */
#define _03_MTU_TVCOR_SKIP_COUNT_3      (0x03U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 3 */
#define _04_MTU_TVCOR_SKIP_COUNT_4      (0x04U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 4 */
#define _05_MTU_TVCOR_SKIP_COUNT_5      (0x05U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 5 */
#define _06_MTU_TVCOR_SKIP_COUNT_6      (0x06U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 6 */
#define _07_MTU_TVCOR_SKIP_COUNT_7      (0x07U) /* Sets the TCIV4 or TCIV7 interrupt skipping count to 7 */
/* TGIA3 or TGIA6 Interrupt Skipping Count Setting (T3ACOR[2:0], T6ACOR[2:0]) */
#define _00_MTU_TACOR_SKIP_COUNT_0      (0x00U) /* Does not skip TGIA3 interrupts */
#define _10_MTU_TACOR_SKIP_COUNT_1      (0x10U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 1 */
#define _20_MTU_TACOR_SKIP_COUNT_2      (0x20U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 2 */
#define _30_MTU_TACOR_SKIP_COUNT_3      (0x30U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 3 */
#define _40_MTU_TACOR_SKIP_COUNT_4      (0x40U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 4 */
#define _50_MTU_TACOR_SKIP_COUNT_5      (0x50U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 5 */
#define _60_MTU_TACOR_SKIP_COUNT_6      (0x60U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 6 */
#define _70_MTU_TACOR_SKIP_COUNT_7      (0x70U) /* Sets the TGIA3 or TGIA6 interrupt skipping count to 7 */
/* T4VEN or T7VEN */
#define _00_MTU_TVEN_DISABLE            (0x00U) /* TCIV4 or TCIV7 interrupt skipping disabled */
#define _08_MTU_TVEN_ENABLE             (0x08U) /* TCIV4 or TCIV7 interrupt skipping enabled */
/* T3AEN or T6AEN */
#define _00_MTU_TAEN_DISABLE            (0x00U) /* TGIA3 or TGIA6 interrupt skipping disabled */
#define _80_MTU_TAEN_ENABLE             (0x80U) /* TGIA3 or TGIA6 interrupt skipping enabled */
...
#define _00_MTU_TRGCOR_SKIP_COUNT_0     (0x00U) /* Does not skip TRGnAN and TRGnBN interrupts */
#define _01_MTU_TRGCOR_SKIP_COUNT_1     (0x01U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 1 */
#define _02_MTU_TRGCOR_SKIP_COUNT_2     (0x02U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 2 */
#define _03_MTU_TRGCOR_SKIP_COUNT_3     (0x03U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 3 */
#define _04_MTU_TRGCOR_SKIP_COUNT_4     (0x04U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 4 */
#define _05_MTU_TRGCOR_SKIP_COUNT_5     (0x05U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 5 */
#define _06_MTU_TRGCOR_SKIP_COUNT_6     (0x06U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 6 */
#define _07_MTU_TRGCOR_SKIP_COUNT_7     (0x07U) /* Sets the TRGnAN and TRGnBN interrupt skipping count to 7 */
...
#define _00_MTU_TGIE5W_DISABLE          (0x00U) /* Interrupt requests TGIW5 disabled */
#define _01_MTU_TGIE5W_ENABLE           (0x01U) /* Interrupt requests TGIW5 enabled */
/* TGR Interrupt Enable 5V (TGIE5V) */
#define _00_MTU_TGIE5V_DISABLE          (0x00U) /* Interrupt requests TGIV5 disabled */
#define _02_MTU_TGIE5V_ENABLE           (0x02U) /* Interrupt requests TGIV5 enabled */
/* TGR Interrupt Enable 5U (TGIE5U) */
#define _00_MTU_TGIE5U_DISABLE          (0x00U) /* Interrupt requests TGIU5 disabled */
#define _04_MTU_TGIE5U_ENABLE           (0x04U) /* Interrupt requests TGIU5 enabled */
