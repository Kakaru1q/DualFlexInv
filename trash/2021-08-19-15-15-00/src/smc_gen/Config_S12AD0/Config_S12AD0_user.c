...
/***********************************************************************************************************************
* Function Name: r_Config_S12AD0_groupb_interrupt
* Description  : This function is GBADI interrupt service routine
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

#if FAST_INTERRUPT_VECTOR == VECT_S12AD_GBADI
#pragma interrupt r_Config_S12AD0_groupb_interrupt(vect=VECT(S12AD,GBADI),fint)
#else
#pragma interrupt r_Config_S12AD0_groupb_interrupt(vect=VECT(S12AD,GBADI))
#endif
