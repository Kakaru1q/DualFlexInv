...
#define _00_CGC_HOCO_CLK_32                 (0x00U) /* 32MHz */
#define _03_CGC_HOCO_CLK_64                 (0x03U) /* 64MHz */

/*
    High-Speed On-Chip Oscillator Wait Control Register (HOCOWTCR)
*/
/* High-Speed On-Chip Oscillator Oscillation Stabilization Wait Time (HSTS[2:0]) */
#define _05_CGC_HOCO_WAIT_CYCLE_142         (0x05U) /* Wait time = 142 cycles */
#define _06_CGC_HOCO_WAIT_CYCLE_270         (0x06U) /* Wait time = 270 cycles */
